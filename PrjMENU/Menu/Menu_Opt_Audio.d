...
instance MENUITEM_AUDIO_SFXVOL(C_MENU_ITEM_DEF)
{
	...
	text[0] = "Sfx volume";
	text[1] = "Sound effects and speech volume";
	posx = 1000;
	posy = MENU_START_Y;
	dimx = 4000;
	dimy = MENU_MAIN_DY;
...
instance MENUITEM_AUDIO_MUSICVOL(C_MENU_ITEM_DEF)
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "Music volume";
	text[1] = "Background music volume";
	posx = 1000;
...
instance MENUITEM_AUDIO_SUB_TITLES(C_MENU_ITEM_DEF)
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "Subtitles";
	text[1] = "Toggle text display durning dialogs on/off";
	posx = 1000;
...
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "Surround subtitles";
	text[1] = "Subtitles for surrounding dialogs on/off";
	posx = 1000;
...
instance MENUITEM_AUDIO_REVERB(C_MENU_ITEM_DEF)
{
	backpic = MENU_ITEM_BACK_PIC;
	text[0] = "Env. reverb";
	text[1] = "Environmental reverb effects in caves, etc.";
	posx = 1000;
