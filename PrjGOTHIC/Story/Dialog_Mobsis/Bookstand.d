...
//			Doc_PrintLine(nDocID,1,"");
			...
			if(FinalDragonEquipment_Once == FALSE)
			{
				...
				Log_AddEntry(TOPIC_TalentRunes,"Ingredients for the rune 'Secret teleport': 1 holy water");
			};
		}
		else
		{
			...
			if(FinalDragonEquipment_Once == FALSE)
			{
				...
				Log_AddEntry(TOPIC_TalentSmith,"If I add 5 units of ore and 5 of dragon blood, I can forge a LARGE ORE DRAGON SLAYER.");
			};
		};
		if(FinalDragonEquipment_Once == FALSE)
		{
