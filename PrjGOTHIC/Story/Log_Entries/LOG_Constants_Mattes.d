...
const string TOPIC_TalbinCheese = "Delicacy";
const string TOPIC_KervoLurkers = "Trapped";
const string TOPIC_BennetOre = "Rare Resource";
const string Log_Text_Addon_EdgorTeach = "Edgor knows everything about bloodflies.";
