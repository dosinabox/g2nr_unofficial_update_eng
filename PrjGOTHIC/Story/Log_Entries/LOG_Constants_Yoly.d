...
const string TOPIC_Addon_HelpDaron = "Lost statuette";
const string TOPIC_Addon_DaronGobbos = "Daron was robbed by a group of vile goblins. He lost a valuable statuette, which he was supposed to deliver to the monastery. These goblins must be hiding in a cave somewhere near the 'Dead Harpy' tavern.";
const string TOPIC_Addon_PedroPass = "I brought the lost statuette to the monastery. Pedro said I can become a novice without paying a tribute. Once I'm inside, I'm to give the statuette to someone in the monastery";
...
const string TOPIC_Addon_LuciasLetter = "Broken heart";
...
const string LogText_Addon_RiordianTeachWisp = "Riordian can teach my will-o'-the-wisp to search for things.";
