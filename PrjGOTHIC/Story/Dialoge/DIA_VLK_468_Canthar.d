...
func void DIA_Canthar_Hallo_Info()
{
	...
	{
		AI_Output(self,other,"DIA_Canthar_Hallo_09_00");	//v
...
func void DIA_Canthar_PAYPRICEINCITY_Ok()
{
	...
	Log_AddEntry(TOPIC_Canthar,"I'm to foist a letter on the merchant Sarah, which will make it look like she's been selling weapons to Onar. Then I'm to go to Lord Andre and rat on her.");
	Info_ClearChoices(DIA_Canthar_PAYPRICEINCITY);
};
