...
func void DIA_Addon_Quarhodron_Hello_tempel()
{
	...
	AI_Output (self, other, "DIA_Addon_Quarhodron_Hello_tempel_11_01");	//The temple will remain closed for all eternity.
	DIA_Addon_Quarhodron_Hello_ChoiceCounter += 1;
	B_Quarhodron_Hello_KommZumPunkt();
};
...
func void DIA_Addon_Quarhodron_GibMirKey_Info()
{
	...
	B_LogEntries(TOPIC_Addon_Kammern,"Quarhodron mentioned the 'Chambers of Adanos' and said that I should beware of them. I really have to find out what he meant if I don't want to run into a trap in the temple of Adanos.");
	B_LogNextEntry(TOPIC_Addon_Quarhodron,"Quarhodron gave me a stone tablet that I can use to open the entrance to the temple of Adanos.");
