...
func void B_GregHints_Followers()
{
	...
	{
		B_LogEntry(TOPIC_Addon_ClearCanyon,"√рег сказал, что € могу вз€ть с собой нескольких реб€т.");
...
func void B_GregHints_Razors()
{
	...
	{
		B_LogEntry(TOPIC_Addon_ClearCanyon,"ќхотитьс€ € должен на бритвозубов.");
...
func void DIA_Addon_Greg_AboutCanyon_Compadres()
{
	...
	{
		AI_Output(self,other,"DIA_Addon_Greg_NW_Bigcross_01_07_add");	//Ќе так уж это и сложно!@@@
	};
	Info_ClearChoices(DIA_Addon_Greg_AboutCanyon);
};
