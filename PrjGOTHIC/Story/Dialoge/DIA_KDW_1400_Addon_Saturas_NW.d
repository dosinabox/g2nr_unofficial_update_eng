...
func void DIA_Addon_Saturas_Nefarius_Info()
{
	...
	if ((ORNAMENT_SWITCHED_FOREST == FALSE) && Npc_HasItems (other, ItWr_Map_NewWorld_Ornaments_Addon))
	{
		...
		AI_PrintScreen("Êàðòà Íåôàðèóñà îòäàíî",-1,YPOS_ItemGiven,FONT_ScreenSmall,2);
		B_UseFakeMap(2);
		...
		AI_PrintScreen("Êàðòà Íåôàðèóñà ïîëó÷åíî",-1,YPOS_ItemTaken,FONT_ScreenSmall,2);
	};
};
...
func void DIA_Addon_Saturas_Ornament_Info()
{
	...
	AI_Output(self,other,"DIA_Addon_Saturas_Ornament_ADD_14_00");	//Âî èìÿ ñóòè âñåãî ñóùåãî, ÷òî ýòî âñå äîëæíî çíà÷èòü?@@@
	if(Lares_Angekommen == TRUE)
	{
