...
func void DIA_Maleth_ToTheCity_Info()
{
	...
	if(VisibleGuild(other) != GIL_BAU)
	{
		...
		Log_AddEntry(TOPIC_City,"Of course, I'd have to look like a farmer first.");
	};
...
func void DIA_Maleth_GEHSTOCK_ok()
{
	...
	{
		B_LogEntry(TOPIC_MalethsGehstock,"Maleth told me there's a large camp of bandits in the woodlands west of Lobart's farm. I'll need to thoroughly search it.");
