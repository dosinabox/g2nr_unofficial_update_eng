...
func void DIA_Jarvis_MissionKO_Info()
{
	...
	{
		B_LogEntry(TOPIC_JarvisSLDKo,"Jarvis wants me to knock a couple of Sylvio's guys down.");
	};
};
...
func void DIA_Jarvis_HowManyLeft_Info()
{
	...
	//		if(MIS_Fester_KillBugs == LOG_OBSOLETE)
		...
		else
		{
			...
			if(other.guild == GIL_NONE)
			{
				AI_Output(self,other,"DIA_Jarvis_HowManyLeft_04_17");	//I'm impressed - if Lee asks me, I can vote for you withou
