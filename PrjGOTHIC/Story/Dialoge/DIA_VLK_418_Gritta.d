...
{
//	AI_Output(self,other,"DIA_Gritta_WantsMoney_Continue03_16_00");	//... большинство даже не слышали о таких вещах. Ќо однажды, € получила известие, что √ритта затонула - так называлс€ этот корабль, мой муж назвал его так из...
