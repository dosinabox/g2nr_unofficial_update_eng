...
func void DIA_Alrik_WannaFight_Info()
{
	...
	if(((Alrik_ArenaKampfVerloren > 0) && !Npc_HasItems(self,ItMw_AlriksSword_Mis)) || !Npc_HasEquippedMeleeWeapon(self))
	{
		...
		else
		{
			...
			{
				B_LogEntry(TOPIC_AlrikSchwert,"Alrik will only fight me if I bring it back to him. ");
			};
	...
	else if((Kapitel <= 2) && (Alrik_ArenaKampfVerloren > 3))
	{
		...
		{
			AI_Output(self,other,"DIA_Alrik_Add_09_02");	//Let me have a short break.
		}
		else
		{
...
func void DIA_Alrik_WerSchwert_Info()
{
	...
	{
		B_LogEntry(TOPIC_AlrikSchwert,"Alrik sold his sword to the merchant Jora.");
	};
