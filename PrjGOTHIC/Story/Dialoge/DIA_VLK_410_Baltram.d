...
{
	AI_Output(self,other,"DIA_Baltram_Sperre_01_00");	//What do you want? You're a convict from the mining colony! I won't do any business with you.
	AI_StopProcessInfos(self);
};
...
func void DIA_Baltram_Trick_Info()
{
	...
	B_LogEntries(TOPIC_Baltram,"If I bring Baltram his delivery, he'll pay me 50 pieces of gold.");
	B_LogNextEntry(TOPIC_Nagur,"Baltram has employed me as an errand-boy. Now I have to collect a delivery from Akil's farm.");
};
