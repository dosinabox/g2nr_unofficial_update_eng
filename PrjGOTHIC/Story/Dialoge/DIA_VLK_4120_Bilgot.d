...
func void DIA_Bilgot_KNOWSLEADSNAPPER_Info()
{
	...
	B_LogEntries(TOPIC_FajethKillSnapper,"Bilgot told me about the leader of a snapper pack. It's supposed to be at the steps to the old watchtower.");
	Log_CreateTopic(TOPIC_BilgotEscort,LOG_MISSION);
	Log_SetTopicStatus(TOPIC_BilgotEscort,LOG_Running);
	B_LogNextEntry(TOPIC_BilgotEscort,"Bilgot wants me to get him out of the valley.");
};
...
instance DIA_Bilgot_TAKEYOUWITHME(C_Info)
{
	...
	permanent = FALSE;
	description = "It's time, Bilgot! Pack your things, we're off.";
};
