...
instance DIA_Addon_Carlos_PERM(C_Info)
{
	...
	permanent = TRUE;
	description = "What's it like leading the hunters?";
};
...
func int DIA_Addon_Carlos_PERM_Condition()
{
	if(Npc_IsDead(Franco))
	{
		DIA_Addon_Carlos_PERM.description = "What's it like leading the hunters?";
	}
	else
	{
		DIA_Addon_Carlos_PERM.description = "Leave me alone!";
	};
	return TRUE;
};
