...
func void DIA_Lobart_STOLENCLOTHS_HowMuch()
{
	...
	{
		Info_AddChoice(DIA_Lobart_STOLENCLOTHS,"All right, I'll pay up, you leave me no choice.",DIA_Lobart_STOLENCLOTHS_GiveGold);
	};
};
...
func void DIA_Lobart_BuyClothes_Info()
{
	...
	Info_AddChoice(DIA_Lobart_BuyClothes,B_BuildPriceString("Give me the work clothes. (Protection: 15/10/0/0.)",Wert_LobartsRuestung),DIA_Lobart_BuyClothes_BUY);
};
...
func void DIA_Lobart_WorkNOW_Ok()
{
	...
	{
		B_LogEntry(TOPIC_Rueben,"Farmer Lobart wants me to harvest the turnip field.");
	};
...
func void DIA_Lobart_ANDREHELPLOBART_Info()
{
	...
	B_LogEntry(TOPIC_Feldraeuber,"Lobart's fields are plagued by field raiders. He wants me to drive them all away.");
