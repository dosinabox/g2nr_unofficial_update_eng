...
func void DIA_Marduk_BEFORETEACH_Info()
{
	...
	if (other.guild != GIL_KDF)
	{
		...
		if(other.guild == GIL_NOV)
		{
			...
			B_LogEntry(Topic_KlosterTeacher,"Brother Marduk can introduce me into arcana of ice and lightning. For that I need to become a Magician of Fire first.");
		};
	}
	else if(!Npc_KnowsInfo(other,DIA_Pyrokar_Lernen))
	{
		Log_CreateTopic(Topic_KlosterTeacher,LOG_NOTE);
		B_LogEntry(Topic_KlosterTeacher,"Brother Marduk can introduce me into arcana of ice and lightning.");
	};
};
...
func void DIA_Marduk_TrainPals_Info()
{
	...
	AI_Output (self, other, "DIA_Marduk_TrainPals_05_01");	//I can, however, bring the essence of Innos and his gifts closer to you.
	AI_Output (self, other, "DIA_Marduk_TrainPals_05_02");	//Besides, it is my task to prepare you for the Consecration of the Sword.
