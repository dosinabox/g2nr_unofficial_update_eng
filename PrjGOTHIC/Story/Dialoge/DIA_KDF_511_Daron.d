...
func void B_DaronSegen()
{
	...
	{
		B_LogEntry(TOPIC_Thorben,"Daron the Magician of Fire gave me his blessing.");
	};
...
func int DIA_Addon_Daron_GuildHelp_Condition()
{
	...
	{
		DIA_Addon_Daron_GuildHelp.description = "I heard rumors about a statuette you have supposedly lost.";
		return TRUE;
	};
};
...
func void DIA_Daron_Spende_Info()
{
	...
	{
		Info_AddChoice(DIA_Daron_Spende,"I'll think about it...",DIA_Daron_Spende_BACK);
		Info_AddChoice(DIA_Daron_Spende,"But I didn't bring enough gold...",DIA_Daron_Spende_NoGold);
