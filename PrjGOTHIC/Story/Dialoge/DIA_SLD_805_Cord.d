...
func void DIA_Addon_Cord_YouAreRanger_Info()
{
	...
	if(MIS_Addon_Lares_ComeToRangerMeeting != LOG_SUCCESS)
	{
		Info_AddChoice(DIA_Addon_Cord_YouAreRanger,"Pay me for my silence.",DIA_Addon_Cord_YouAreRanger_Gold);
	};
};
...
func void B_Cord_IDoItForYou_Dexter()
{
	...
	B_LogEntries(TOPIC_Addon_MissingPeople,"Cord the mercenary is looking for his buddy Patrick.");
	B_LogNextEntry(TOPIC_Addon_RangerHelpSLD,"Leader of the bandits is called Dexter.");
