...
{
	AI_Output(other,self,"DIA_Fajeth_SNAPPER_KILLED_15_00");	//The snappers are done for.
	AI_Output(self,other,"DIA_Fajeth_SNAPPER_KILLED_12_01");	//Good job. We should be able to handle all the other beasts out there.
	if(Fajeth_Pay == TRUE)
	{
		AI_Output(self,other,"DIA_Fajeth_SNAPPER_KILLED_12_02");	//You have earned your gold - here are 100 gold pieces, as agreed.
		B_GiveInvItems(self,other,ItMi_Gold,100);
	};
	self.flags = 0;
	MIS_Fajeth_Kill_Snapper = LOG_SUCCESS;
