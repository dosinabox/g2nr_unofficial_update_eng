...
func void DIA_Babera_Rosi_Info()
{
	...
	B_LogEntries(TOPIC_RosisFlucht,"Rosi has run away from Sekob's farm. Babera says she left the farm and went towards the north, into the woods.");
	B_LogNextEntry(TOPIC_bringRosiBackToSekob,"Rosi has run away from Sekob's farm. Babera says she left the farm and went towards the north, into the woods.");
};
