...
func void DIA_Addon_Samuel_Recipe_Info()
{
	...
	{
		Info_AddChoice(DIA_Addon_Samuel_Recipe,"(Give: 'Lou's Hammer' recipe)",DIA_Addon_Samuel_Recipe_LousHammer);
	};
	if((Samuel_Knows_SchlafHammer == FALSE) && Npc_HasItems(other,ITWr_Addon_Lou_Rezept2))
	{
		Info_AddChoice(DIA_Addon_Samuel_Recipe,"(Give: 'Lou's Double Hammer' recipe)",DIA_Addon_Samuel_Recipe_LousDoubleHammer);
	};
};
...
instance DIA_Addon_Samuel_Grog(C_Info)
{
	...
	permanent = TRUE;
	description = B_BuildPriceString("I've come to get my ration of grog!",Value_Grog);
};
...
instance DIA_Addon_Samuel_Rum(C_Info)
{
	...
	permanent = TRUE;
	description = B_BuildPriceString("Give me some rum.",Value_Rum);
};
...
func void B_BuildSamuelDrinksDialog()
{
	...
	{
		Info_AddChoice(DIA_Addon_Samuel_Stronger,B_BuildPriceString("Lou's Double Hammer",Value_SchlafHammer),DIA_Addon_Samuel_Stronger_LousDoubleHammer);
	};
	if(Samuel_Knows_LousHammer == TRUE)
	{
		Info_AddChoice(DIA_Addon_Samuel_Stronger,B_BuildPriceString("Lou's Hammer",Value_LousHammer),DIA_Addon_Samuel_Stronger_LousHammer);
	};
	Info_AddChoice(DIA_Addon_Samuel_Stronger,B_BuildPriceString("Hasty Herring",Value_SchnellerHering),DIA_Addon_Samuel_Stronger_SchnellerHering);
};
