...
func int B_TeachPlayerTalentForeignLanguage(var C_Npc slf,var C_Npc oth,var int Language)
{
	...
	if(Language == LANGUAGE_1)
	{
		...
		PrintScreen("Learned: Language of Peasants",-1,-1,FONT_Screen,2);
	};
	if(Language == LANGUAGE_2)
	{
		...
		PrintScreen("Learned: Language of Warriors",-1,-1,FONT_Screen,2);
	};
	if(Language == LANGUAGE_3)
	{
		...
		PrintScreen("Learned: Language of Priests",-1,-1,FONT_Screen,2);
	};
